...
class Room3DWebsite {
    ...
    setupAnimations() {
        ...
        const animateElements = document.querySelectorAll('.pricing-card, .section-header');
    ...
    setupAuthModal() {
        ...
        const switchForm = (formType) => {
            ...
            document.querySelector(`.auth-form.${formType}-form`).classList.add('active');
        ...
        function parallaxHero() {
            ...
            if (heroVisual) {
                ...
                heroLayers.forEach(layer => {
                    ...
                    layer.style.transform = `translateY(${scrolled * speed}px) rotate(${layer.classList.contains('layer-1') ? -15 : 15}deg)`;
                });
            }
            ticking = false;
        }
